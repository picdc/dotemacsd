...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Fira Code" :slant normal :weight normal :height 105 :width normal :foundry "CTDB"))))
 '(fixed-pitch ((t (:family "Fira Code" :slant normal :weight normal :height 105 :width normal :foundry "CTDB"))))
 ...
 '(tuareg-font-lock-governing-face ((t (:foreground "wheat" :weight bold))))

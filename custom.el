...
(custom-set-variables
 ...
 '(pokemacs-layout-sidebar-width "25%")
 ...
 '(vertico-multiform-categories
   '((imenu posframe posframe posframe buffer)
     (file posframe posframe posframe
           (vertico-sort-function . sort-directories-first))
     (corfu posframe posframe posframe
            (vertico-sort-function . vertico-sort-alpha))
     (jinx posframe posframe posframe grid (vertico-grid-annotate . 20))
     (symbol posframe posframe posframe
             (vertico-sort-function . vertico-sort-history-length-alpha))))
 '(vertico-multiform-commands
   '((consult-imenu posframe posframe posframe buffer)
     (consult-line posframe posframe posframe buffer)
     (execute-extended-command posframe posframe posframe mouse)
     (find-file posframe posframe posframe
                (vertico-sort-function . sort-directories-first))
     (insert-char posframe posframe posframe
                  (vertico-sort-function . sort-characters))
     (describe-symbol posframe posframe posframe

...
(custom-set-faces
 ...
 '(child-frame-border ((t (:background "#292e39"))))
 '(fixed-pitch ((t (:family "Fira Code" :slant normal :weight medium :height 100 :width normal :foundry "CTDB"))))
 '(highlight ((t (:extend t :foreground unspecified))))
 '(lsp-lens-face ((t (:family "Fira Code" :foundry "CTDB" :inherit lsp-details-face))))
 '(match ((t (:inherit font-lock-keyword-face :weight normal))))
 '(menu ((t (:inherit mode-line :height 100))))
 '(mode-line ((t :inherit fixed-pitch)))
 '(mode-line-inactive ((nil :family "Fira Code" :height 100)))
 ...
 '(tuareg-font-lock-constructor-face ((t (:inherit font-lock-builtin-face))))
 '(tuareg-font-lock-governing-face ((t (:inherit font-lock-keyword-face))))
 '(variable-pitch ((t (:weight regular :height 90 :family "Ubuntu")))))

...
(custom-set-variables
 ...
 '(vertico-multiform-categories
   '((imenu posframe buffer)
     (file posframe (vertico-sort-function . sort-directories-first))
     (corfu posframe (vertico-sort-function . vertico-sort-alpha))
     (jinx posframe grid (vertico-grid-annotate . 20))
     (symbol posframe
             (vertico-sort-function . vertico-sort-history-length-alpha))))
 '(vertico-multiform-commands
   '((consult-imenu posframe buffer) (consult-line posframe buffer)
     (execute-extended-command posframe mouse)
     (find-file posframe (vertico-sort-function . sort-directories-first))
     (insert-char posframe (vertico-sort-function . sort-characters))
     (describe-symbol posframe
